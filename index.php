        ...
        <nav class="nk-navbar nk-navbar-top nk-navbar-sticky nk-navbar-transparent nk-navbar-white-text-on-top">
            <div class="container">
                <div class="nk-nav-table">
                    <a href="https://livesugar3.herokuapp.com/" class="nk-nav-logo">
                    ...
                    <ul class="nk-nav nk-nav-right hidden-md-down" data-nav-mobile="#nk-nav-mobile">
                        ...
                        <li>
                            <a href="index.html#blog">Our Products</a>
                        </li>
                        <li>
    ...
    <div class="nk-main">
        ...
        <div class="nk-header-title nk-header-title-full">
            <div class="bg-image">
                ...
                <div class="bg-image-overlay" style="background-color: rgba(12, 12, 12, 0.2);"></div>
            </div>
            <div class="nk-header-table">
                <div class="nk-header-table-cell">
                    <div class="container">

                        <h2 class="nk-subtitle">Welcome To Livsugar</h2>


                        <h1 class="nk-title display-3">
                            <em class="fw-400">We make livsugar natural sweetener</em>
                        </h1>
        ...
        <div class="nk-box bg-gray-1" id="about">
            <div class="container">
                <div class="row" style="padding-top: 90px;">
                	<div class="col-lg-6 text-xs-center">
						<img src="assets/images/work-18.jpg" class="img-responsive" alt="">
                    </div>
                    <div class="col-lg-6 text-xs-center">
        ...
        <!-- END: About Our Agency -->
         ...
         <!-- START: Blog -->
		        <div class="nk-box bg-gray-1" id="blog">
		            ...
		            <h2 class="text-xs-center display-4" style="padding-top: 90px;">Our Products</h2>
		                                    ...
		                                    <div class="nk-blog-post">
		                                        <div class="nk-post-thumb">
		                                            <a href="blog-single.html">
		                                                <img src="assets/images/work-10.jpg" alt="" class="nk-img-stretch">
		                                            </a>
		                                            <div class="nk-post-category"><a href="#">Livsugar</a></div>
		                                        </div>
		                                        ...
		                                        <div class="nk-post-text">
		                                            <p>LIVSUGAR, made from Stevia, is a 100% natural, chemical-free sweetener that replaces the sugar intake from your daily diet.</p>
		                                        </div>
		                                    </div>
		                                </div>
		                            ...
		                            <div>
		                                <div class="pl-15 pr-15">
		                                    <div class="nk-blog-post">
		                                        <div class="nk-post-thumb">
		                                            <a href="blog-single.html">
		                                                <img src="assets/images/work-11.jpg" alt="" class="nk-img-stretch">
		                                            </a>
		                                            <div class="nk-post-category"><a href="#">Livsugar</a></div>
		                                        </div>
		                            ...
		                            <div>
		                                <div class="pl-15 pr-15">
		                                    <div class="nk-blog-post">
		                                        <div class="nk-post-thumb">
		                                            <a href="blog-single.html">
		                                                <img src="assets/images/work-12.jpg" alt="" class="nk-img-stretch">
		                                            </a>
		                                            <div class="nk-post-category"><a href="#">Livsugar</a></div>
		                                        </div>
		                            ...
		                            <div>
		                                <div class="pl-15 pr-15">
		                                    <div class="nk-blog-post">
		                                        <div class="nk-post-thumb">
		                                            <a href="blog-single.html">
		                                                <img src="assets/images/work-13.jpg" alt="" class="nk-img-stretch">
		                                            </a>
		                                            <div class="nk-post-category"><a href="#">Livsugar</a></div>
		                                        </div>
		                                        <h2 class="nk-post-title h4"><a href="blog-single.html">The History of Nature</a></h2>
		                            ...
		                            <div>
		                                <div class="pl-15 pr-15">
		                                    <div class="nk-blog-post">
		                                        <div class="nk-post-thumb">
		                                            <a href="blog-single.html">
		                                                <img src="assets/images/work-14.jpg" alt="" class="nk-img-stretch">
		                                            </a>
		                                            <div class="nk-post-category"><a href="#">Livsugar</a></div>
		                                        </div>
		                                        <h2 class="nk-post-title h4"><a href="blog-single.html">Why you should Use It</a></h2>
        ...
        <div class="container" id="contact">
            ...
            <div class="row vertical-gap" style="padding-top: 90px;">
                <div class="col-lg-5">
                    <!-- START: Info -->
                    ...
                    <ul class="nk-contact-info">
                        <li>
                            <strong>Address:</strong> E-2/S-9, Punyoday Park, Near Don Bosco School, Adharwadi, Kalyan (W)- 421301, Mumbai, Maharashtra, INDIA.</li>
                        <li>
                            <strong>Phone:</strong> 0251 - 3245966/ +91 - 9323466906</li>
                        <li>
                            <strong>Email:</strong> livkonpharma@gmail.com</li>
                        <li>
            ...
            <div class="nk-footer-cont">
                <div class="container text-xs-center">
                    ...
                    <div class="nk-footer-text">
                        <p>2017 &copy; Design by Livsugar</p>
                    </div>
                </div>
            </div>
        </footer>
